...
def jtKls():
    ...
    click_button_in_window("map-exit.png",click_delay=1.5)
...
def reStart():
    ...
    find_and_click_until_stop("startgame.png","zmxyOL.png",click_delay=3)
    time.sleep(5)
